...
<section class="section-all--commemoration">
    <div class="row">
        ...
        <div class="content_img">
            ...
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-2.jpeg" alt="commemoration-methe-2">
            </div>
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-3.jpeg" alt="commemoration-methe-3">
            </div>
        </div>
        <div class="content-img">
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-4.jpeg" alt="commemoration-methe-4">
            </div>
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-5.jpeg" alt="commemoration-methe-5">
            </div>
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-6.jpeg" alt="commemoration-methe-6">
            </div>
        </div>
        <div class="content-img">
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-7.jpeg" alt="commemoration-methe-7">
            </div>
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-8.jpeg" alt="commemoration-methe-9">
            </div>
            <div class="col-1-of-3">
                <img class="img1" id="img" src="img/commemoration-methe-9.jpeg" alt="commemoration-methe-9">
            </div>
        </div>
    </div>
